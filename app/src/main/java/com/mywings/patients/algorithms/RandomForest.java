...
public class RandomForest {
    ...
    public static String GenerateTrees(ArrayList Objarray, String gender) {
        ...
        //Rule of RF
        double w = (double) Ncount / Fxcount;
        String TreeRule = "";

        if (w >= Th1)//firs threshold
            TreeRule = "SystolicBP=" + sysFinalResult + ",DystolicBP=" + dysFinalResult + ",Heart-Rate=" + hpFinalResult + ",cholesterol=" + chFinalResult + ",cholesterol-LDL=" + ldlFinalResult + ",cholesterol-HDL=" + hdlFinalResult + ",Stress=" + stressFinalResult + ",sugar=" + sugarFinalResult + ",Oxygen-saturation=" + oxyFinalResult + ",Hemoglobin=" + hemoFinalResult + ",ECG-PR-Interval=" + prFinalResult + ",ECG-QT-Interval" + qtFinalResult + " Then HealthStatus=Critical";
        else if (w >= Th2 && w < Th1)//Second threshold
            TreeRule = "SystolicBP=" + sysFinalResult + ",DystolicBP=" + dysFinalResult + ",Heart-Rate=" + hpFinalResult + ",cholesterol=" + chFinalResult + ",cholesterol-LDL=" + ldlFinalResult + ",cholesterol-HDL=" + hdlFinalResult + ",Stress=" + stressFinalResult + ",sugar=" + sugarFinalResult + ",Oxygen-saturation=" + oxyFinalResult + ",Hemoglobin=" + hemoFinalResult + ",ECG-PR-Interval=" + prFinalResult + ",ECG-QT-Interval" + qtFinalResult + " Then HealthStatus=Moderate";
        else if (w > Th3 && w < Th2)//Second threshold
            TreeRule = "SystolicBP=" + sysFinalResult + ",DystolicBP=" + dysFinalResult + ",Heart-Rate=" + hpFinalResult + ",cholesterol=" + chFinalResult + ",cholesterol-LDL=" + ldlFinalResult + ",cholesterol-HDL=" + hdlFinalResult + ",Stress=" + stressFinalResult + ",sugar=" + sugarFinalResult + ",Oxygen-saturation=" + oxyFinalResult + ",Hemoglobin=" + hemoFinalResult + ",ECG-PR-Interval=" + prFinalResult + ",ECG-QT-Interval" + qtFinalResult + " Then HealthStatus=Mild";
        else
            TreeRule = "SystolicBP=" + sysFinalResult + ",DystolicBP=" + dysFinalResult + ",Heart-Rate=" + hpFinalResult + ",cholesterol=" + chFinalResult + ",cholesterol-LDL=" + ldlFinalResult + ",cholesterol-HDL=" + hdlFinalResult + ",Stress=" + stressFinalResult + ",sugar=" + sugarFinalResult + ",Oxygen-saturation=" + oxyFinalResult + ",Hemoglobin=" + hemoFinalResult + ",ECG-PR-Interval=" + prFinalResult + ",ECG-QT-Interval" + qtFinalResult + " Then HealthStatus=Normal";
        System.out.println(s);
        System.out.println("Current RF Weight" + w);
        System.out.println("RF Rule is \t:" + TreeRule);
        return s;
    }
