...
public class DoctorRegistrationAsync extends AsyncTask<JSONObject, Void, JSONObject> {
    ...
    protected JSONObject doInBackground(JSONObject... params) {
        try {
            return new JSONObject(httpConnectionUtil.requestPost(Constant.URL + Constant.REGISTER_DOCTOR, params[0]));
